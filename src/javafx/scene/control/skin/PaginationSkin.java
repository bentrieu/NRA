...
public class PaginationSkin extends SkinBase<Pagination> {
    ...
    private javafx.scene.control.skin.PaginationSkin.NavigationControl navigation;
...
//        setManaged(false);
        ...
        this.navigation = new javafx.scene.control.skin.PaginationSkin.NavigationControl();
    ...
    private final DoubleProperty arrowButtonGap = new StyleableDoubleProperty(60.0) {
        @Override public Object getBean() {
            return javafx.scene.control.skin.PaginationSkin.this;
        }
        @Override public String getName() {
            return "arrowButtonGap";
        }
        @Override public CssMetaData<Pagination,Number> getCssMetaData() {
            return javafx.scene.control.skin.PaginationSkin.StyleableProperties.ARROW_BUTTON_GAP;
        }
    };
        ...
        if (arrowsVisible == null) {
            arrowsVisible = new StyleableBooleanProperty(DEFAULT_ARROW_VISIBLE) {
                ...
                public CssMetaData<Pagination,Boolean> getCssMetaData() {
                    return javafx.scene.control.skin.PaginationSkin.StyleableProperties.ARROWS_VISIBLE;
                }
    ...
    private final BooleanProperty pageInformationVisibleProperty() {
        if (pageInformationVisible == null) {
            pageInformationVisible = new StyleableBooleanProperty(DEFAULT_PAGE_INFORMATION_VISIBLE) {
                ...
                @Override
                public CssMetaData<Pagination,Boolean> getCssMetaData() {
                    return javafx.scene.control.skin.PaginationSkin.StyleableProperties.PAGE_INFORMATION_VISIBLE;
                }
        ...
        if (pageInformationAlignment == null) {
            pageInformationAlignment = new StyleableObjectProperty<Side>(Side.BOTTOM) {
                ...
                public CssMetaData<Pagination,Side> getCssMetaData() {
                    return javafx.scene.control.skin.PaginationSkin.StyleableProperties.PAGE_INFORMATION_ALIGNMENT;
                }
    ...
    private final BooleanProperty tooltipVisibleProperty() {
        if (tooltipVisible == null) {
            tooltipVisible = new StyleableBooleanProperty(DEFAULT_TOOLTIP_VISIBLE) {
                ...
                @Override
                public CssMetaData<Pagination,Boolean> getCssMetaData() {
                    return javafx.scene.control.skin.PaginationSkin.StyleableProperties.TOOLTIP_VISIBLE;
                }
    ...
    class NavigationControl extends StackPane {
        ...
        private void initializePageIndicators() {
            ...
            for (int i = fromIndex; i <= toIndex; i++) {
                javafx.scene.control.skin.PaginationSkin.IndicatorButton ib = new javafx.scene.control.skin.PaginationSkin.IndicatorButton(i);
        ...
        private void clearIndicatorButtons() {
            for (Toggle toggle : indicatorButtons.getToggles()) {
                if (toggle instanceof javafx.scene.control.skin.PaginationSkin.IndicatorButton) {
                    javafx.scene.control.skin.PaginationSkin.IndicatorButton indicatorButton = (javafx.scene.control.skin.PaginationSkin.IndicatorButton) toggle;
        ...
        private void updatePageIndicators() {
            for (int i = 0; i < indicatorButtons.getToggles().size(); i++) {
                javafx.scene.control.skin.PaginationSkin.IndicatorButton ib = (javafx.scene.control.skin.PaginationSkin.IndicatorButton)indicatorButtons.getToggles().get(i);
        ...
        private void layoutPageIndicators() {
            ...
            for (int i = 0; i < getMaxPageIndicatorCount(); i++) {
                ...
                if (index != -1) {
                    javafx.scene.control.skin.PaginationSkin.IndicatorButton ib = (javafx.scene.control.skin.PaginationSkin.IndicatorButton)indicatorButtons.getToggles().get(index);
    ...
    class IndicatorButton extends ToggleButton {
        ...
        public IndicatorButton(int pageNumber) {
            ...
            setOnAction(arg0 -> {
                ...
                if (selected != javafx.scene.control.skin.PaginationSkin.IndicatorButton.this.pageNumber) {
                    pagination.setCurrentPageIndex(javafx.scene.control.skin.PaginationSkin.IndicatorButton.this.pageNumber);
                    requestLayout();
                }
            });
        ...
        private void setTooltipVisible(boolean b) {
            if (b) {
                setTooltip(new Tooltip(Integer.toString(javafx.scene.control.skin.PaginationSkin.IndicatorButton.this.pageNumber + 1)));
            } else {
                setTooltip(null);
            }
        }
        ...
        private static final CssMetaData<Pagination,Boolean> ARROWS_VISIBLE =
                new CssMetaData<Pagination,Boolean>("-fx-arrows-visible",
                    ...
                    public boolean isSettable(Pagination n) {
                        final javafx.scene.control.skin.PaginationSkin skin = (javafx.scene.control.skin.PaginationSkin) n.getSkin();
    ...
    public static List<CssMetaData<? extends Styleable, ?>> getClassCssMetaData() {
        return javafx.scene.control.skin.PaginationSkin.StyleableProperties.STYLEABLES;
    }
