...
import article.ArticlesManager;
import article.Helper;
...
public class HomeSceneController implements Initializable {
    ...
    public HomeSceneController() {
        ...
        loader.setLocation(getClass().getClassLoader().getResource("layouts/Layout.fxml"));
    ...
    public void initialize(URL url, ResourceBundle resourceBundle) {
        ...
        whiteLoadingImage = new Image("/images/book_loadinganimation_white.gif");
        darkLoadingImage = new Image("/images/book_loadinganimation_dark.gif");
            ...
            for (int i = 10 * pageindex, k = 0; i < 10 + 10 * pageindex; i++, k++) {
                ...
                switch (articlesList.get(i).getSource()) {
                    case "vnexpress":
                        ...
                        imageSourceList[k].setImage(new Image("images/vnexpress_small.png"));
                    ...
                    case "zingnews":
                        ...
                        imageSourceList[k].setImage(new Image("images/zingnews_small.png"));
                        buttonList[k].setOnAction(e -> {
                            displayFullArticleVbox.getChildren().clear();
                            borderPaneUnderScrollPane.setCenter(null);
                            borderPaneUnderScrollPane.setCenter(loadingStackPane);
                    ...
                    case "tuoitre":
                        ...
                        imageSourceList[k].setImage(new Image("images/tuoitre_small.png"));
                        buttonList[k].setOnAction(e -> {
                            displayFullArticleVbox.getChildren().clear();
                            borderPaneUnderScrollPane.setCenter(null);
                            borderPaneUnderScrollPane.setCenter(loadingStackPane);
                    ...
                    case "nhandan":
                        ...
                        imageSourceList[k].setImage(new Image("images/nhandan_small.png"));
                        buttonList[k].setOnAction(e -> {
                            displayFullArticleVbox.getChildren().clear();
                            borderPaneUnderScrollPane.setCenter(null);
                            borderPaneUnderScrollPane.setCenter(loadingStackPane);
                    ...
                    case "thanhnien":
                        ...
                        imageSourceList[k].setImage(new Image("images/thanhnien_small.png"));
                        buttonList[k].setOnAction(e -> {
                            displayFullArticleVbox.getChildren().clear();
                            borderPaneUnderScrollPane.setCenter(null);
                            borderPaneUnderScrollPane.setCenter(loadingStackPane);
